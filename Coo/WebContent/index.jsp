...
<div id="page" class="container">
	<div id="header">
		<div id="logo">
			...
			<h1><a href="#">HOMELESS-ClO</a></h1>
			<span> <a href="http://templated.co" rel="nofollow"></a></span>
		</div>
		<div id="menu">
			<ul>
				<li class="current_page_item"><a href="#" accesskey="1" title="">Homepage</a></li>
				<li><a href="#" accesskey="2" title="">Nuestros clientes</a></li>
				<li><a href="#" accesskey="3" title="">Acerca de nosotros</a></li>
				<li><a href="#" accesskey="4" title="">Productos</a></li>
				<li><a href="#" accesskey="5" title="">Contactanos</a></li>
				<li><a href="http://localhost:8080/Formulario/index.jsp" accesskey="5" title="">Registrate</a></li>
			</ul>
		</div>
	</div>
	<div id="main">
		...
		<div id="welcome"><h2>PRODUCTOS</h2>
